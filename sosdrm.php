...
'html lang="fr-FR">'.
'   <head>'.
'   <title><center>SOS DRM</center></title>'.
'    <meta charset="utf-8" :>'.
'   </head>'.
'   <link rel="stylesheet" href="style.css">'.
'   <body>'.
'   <main>'.
'       <h1><center>SOS DRM</center></h1><br />'.
'       <p>Un DRM (Digital Rights Managements) ou gestion numérique des restrictions en français est une protection qu\'utilisent des médias comme des chaînes de télévision.</p>'.
'       <p>Depuis le 12 juin 2023, je suis confronté à cela pour MYTF1. Je ne peux plus visionner ni télécharger via captvty des émissions et surtout ma série préférée qui n\'est qu\'autre que <i>Les Mystères de l\'Amour</i>.</p><br />'.
'       <img src="drm.png"><br />'.
'       <p>Voici un exemple emblématique (à l\'heure où j\'écris nous sommes début juillet deux mille vingt-quatre donc cela fait plus un an que le calvaire dure).</p> <br />'.
'       <p>Retrouvons la liberté que nous avions autrefois de visionner librement cette série et bien d\'autres.</p>'.
'       '.
'      <!--à créer--> '.
'    </main>'.
'  '.
